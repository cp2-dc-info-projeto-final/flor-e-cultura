<script lang="ts">
  ...
  // Abre a página de termos na mesma aba usando o roteamento do SvelteKit.
    ...
    <div class="w-full bg-white rounded-lg shadow dark:border sm:max-w-md xl:p-0 dark:bg-white dark:border-gray-700">
      <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
        ...
        <form on:submit|preventDefault={cadastrarUsuario} class="space-y-4 md:space-y-6">
          ...
          <!-- Checkbox de Termos — chama abrirTermos() para navegar à rota /termos -->
          <div class="mt-2">
            <label class="flex items-start space-x-3 text-sm text-gray-800 dark:text-gray-200">
              ...
              <span class="font-light text-gray-500 dark:text-gray-400">
                ...
                <a
                  id="termos-help"
                  href="/termos"
                  on:click|preventDefault={abrirTermos}
                  class="text-blue-600 hover:underline font-medium dark:text-green-500"
                >
                  Termos e Condições
                </a>.
              </span>
          ...
          <p class="text-sm font-light text-gray-500 dark:text-gray-400">
            Já possui uma conta?
            <a href="/login" class="font-medium text-blue-600 hover:underline dark:text-green-500">
              Faça login
            </a>
          </p>
        </form>
